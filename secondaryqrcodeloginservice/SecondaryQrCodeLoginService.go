...
func (p ErrorCode) String() string {
	...
	case ErrorCode_VERIFICATION_FAILED:
		return "VERIFICATION_FAILED"
	case ErrorCode_NOT_ALLOWED_QR_CODE_LOGIN:
		return "NOT_ALLOWED_QR_CODE_LOGIN"
	case ErrorCode_VERIFICATION_NOTICE_FAILED:
		return "VERIFICATION_NOTICE_FAILED"
	case ErrorCode_RETRY_LATER:
		return "RETRY_LATER"
	case ErrorCode_INVALID_CONTEXT:
		return "INVALID_CONTEXT"
	case ErrorCode_APP_UPGRADE_REQUIRED:
...
func ErrorCodeFromString(s string) (ErrorCode, error) {
	...
	case "VERIFICATION_FAILED":
		return ErrorCode_VERIFICATION_FAILED, nil
	case "NOT_ALLOWED_QR_CODE_LOGIN":
		return ErrorCode_NOT_ALLOWED_QR_CODE_LOGIN, nil
	case "VERIFICATION_NOTICE_FAILED":
		return ErrorCode_VERIFICATION_NOTICE_FAILED, nil
	case "RETRY_LATER":
		return ErrorCode_RETRY_LATER, nil
	case "INVALID_CONTEXT":
		return ErrorCode_INVALID_CONTEXT, nil
	case "APP_UPGRADE_REQUIRED":
		return ErrorCode_APP_UPGRADE_REQUIRED, nil
	}
